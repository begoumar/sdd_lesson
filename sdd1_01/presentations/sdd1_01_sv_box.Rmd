...
- Recherchez votre fichier `dossier_partage.txt` dans votre ordinateur hôte (Windows, MacOS, ...) et notez la position du fichier.
...
- Recherchez à nouveau votre fichier `dossier_partage.txt` à partir de votre ordinateur hôte et notez la position du fichier.
