...
Les chercheurs souhaitent visualiser  la variation des paramètres physico-chimiques le long  du transect
...
#data(Polio)
#?Polio
# insérer une variable Mois dans df. polio
library(dplyr)
polio %>% mutate(Mois = c(1:168)) -> polio
# Choisir la méthode régularisation (par valeur constante, linéaire ...)
plot(polio$Mois, polio$Cases, type = "l", xlab = "Mois", ylab = "Cases")
```


* Jeu de données : polio.csv

### Les séries spatio-temporelles

 Diagramme décisionnel 

```{r,fig.align='center', echo=FALSE, out.width= '85%'}
knitr::include_graphics("../images/ts.png")
```
